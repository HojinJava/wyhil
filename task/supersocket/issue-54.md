...
git checkout -b vibe/antigravity/socket-login-feature-l1-54 origin/antigravity

위 명령 실행 후 supersocket 폴더 안에서 작업을 진행한다.

## 해야 할 작업

공통 프롬프트는 .claude/feature-definitions/socket-login-feature-l1.md 참고
...
git push origin vibe/antigravity/socket-login-feature-l1-54
```
