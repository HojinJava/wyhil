...
아래 명령으로 PR 내용을 확인한다.
gh pr view 39 --repo HojinJava/wyhil
...
```
git mv task/mall/review-36.md task_done/mall/review-36.md
git commit -m "chore: move review-36 task to task_done"
