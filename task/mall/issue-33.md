# mall/test_1 [L1] — 작업 지시 (#33)

## 지금 바로 실행

git fetch origin antigravity
git checkout -b vibe/antigravity/mall-test_1-33 origin/antigravity
...
PR 본문에 `References #33` 를 반드시 포함한다.
PR에 본인 모델 라벨을 추가한다.
...
```
git mv task/mall/issue-33.md task_done/mall/issue-33.md
git commit -m "chore: move issue-33 task to task_done"
git push origin vibe/antigravity/mall-test_1-33
```
