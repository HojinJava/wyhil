# mall/dash-bord-user1 [L1] — 작업 지시 (#31)

## 지금 바로 실행

git fetch origin antigravity
git checkout -b vibe/antigravity/mall-dash-bord-user1-31 origin/antigravity
...
PR 본문에 `References #31` 를 반드시 포함한다.
PR에 본인 모델 라벨을 추가한다.
...
git push origin vibe/antigravity/mall-dash-bord-user1-31
```
