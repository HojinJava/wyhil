# socket/test3 [L1] — 작업 지시 (#37)

## 지금 바로 실행

git fetch origin antigravity
git checkout -b vibe/antigravity/socket-test3-37 origin/antigravity
...
PR 본문에 `References #37` 를 반드시 포함한다.
PR에 본인 모델 라벨을 추가한다.
...
```
git mv task/supersocket/issue-37.md task_done/supersocket/issue-37.md
git commit -m "chore: move issue-37 task to task_done"
git push origin vibe/antigravity/socket-test3-37
```
